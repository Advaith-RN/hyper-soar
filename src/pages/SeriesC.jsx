  ...
  return (
    <div className='h-screen overflow-y-hidden'>
        ...
        <div className='h-[91%] justify-center flex flex-col items-center'>
            <div className='h-[70%] w-[95%] flex flex-row'>
                <div className='w-[50%]'>
                ...
                <div className='w-[50%] flex flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-row mt-[20%] gap-16'>
                        <img src='../categories/lightweight.png' className='w-36'/>
                        <img src='../categories/quickcharge.png' className='w-36'/>
                        <img src='../categories/stable.png' className='w-36'/>
                    </div>
                </div>
            </div>
            <div className='h-[30%] w-[95%] bg-dark-gray mb-[2%]'>
                <h1 className='text-white font-integral text-9xl pl-[3%]'>Icarus</h1>
